...
All operations go through `scripts/s2.py`. **Invoke with `python3`** (the `python` alias isn't on PATH). Run `python3 scripts/s2.py <command> --help` for the full surface.
